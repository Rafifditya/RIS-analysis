...
@Component({
  selector: 'app-forecasttwo',
  templateUrl: './forecasttwo.component.html',
  styleUrls: ['./forecasttwo.component.css']
})
export class ForecasttwoComponent implements OnInit {
  ...
  constructor(private predservice: PredictiontwoService) { }
...
// tslint:disable-next-line: prefer-for-of
      ...
      let myChart = new Chart(ctx, {
        ...
        options: {
          title: {
						display: true,
						text: 'Prediction Baseline-7 day'
					},
          legend: {
            display: true
          },
